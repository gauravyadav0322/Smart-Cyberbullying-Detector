...
User enters text in the web application.

The text is transformed using the saved TF-IDF vocabulary.

The machine learning model predicts whether the text is bullying or non-bullying.

The result is displayed on the webpage with visual styling.
